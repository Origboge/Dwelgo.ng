...
export const PropertiesPage: React.FC = () => {
  ...
  const filteredProperties = useMemo(() => {
    return MOCK_PROPERTIES.filter((prop) => {
      ...
      const matchesListing = listingType === 'All' || prop.listingType === listingType;
      const matchesPrice = prop.price <= priceRange;

      return matchesSearch && matchesType && matchesListing && matchesPrice;
    });
  }, [searchTerm, selectedType, listingType, priceRange]);
              ...
              <div>
                ...
                <div className="flex rounded-md shadow-sm" role="group">
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-medium border border-gray-300 dark:border-slate-700 rounded-l-md ${
                      listingType === 'All'
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-medium border-t border-b border-gray-300 dark:border-slate-700 ${
                      listingType === 'Sale'
                        ? 'bg-zillow-50 text-zillow-600 border-zillow-600 z-10' 
                        : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-gray-50'
                    }`}
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-medium border border-gray-300 dark:border-slate-700 rounded-r-md ${
                      listingType === 'Rent'
                        ? 'bg-zillow-50 text-zillow-600 border-zillow-600 z-10' 
                        : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-gray-50'
                    }`}
